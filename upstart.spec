...
# send close fd command to shell first (#618995)
Patch6:         upstart-close-fd.patch
# avoid assertion in telinit u on ppc64 (#648431)
Patch7:         upstart-telinit-retval.patch
# set bugreport value to launchpad
Patch8:		upstart-0.6.5-bugreport.patch
# add support for override files
Patch9: 	upstart-0.6.5-override.patch
# add usage stanza
Patch10:	upstart-0.6.5-usage.patch
# mount proc and sys in upstart
...
%patch6 -p1 -b .closefd
%patch7 -p1 -b .telinit-ret
%patch8 -p1 -b .bugreport
%patch9 -p1 -b .override
%patch10 -p1 -b .usage
%patch11 -p0 -b .mount
%patch12 -p1 -b .echo
...
%build
%configure --sbindir=/sbin --libdir=/%{_lib} --disable-silent-rules \
...
- mount proc and sys (#798551)

* Thu Feb 02 2012 Lukas Nykryn <lnykryn@redhat.com> 0.6.5-11
- set BUGREPORT value to launchpad (#771736)
- add support for override files (#663594)
- add usage stanza (#735427)

* Tue Feb 15 2011 Petr Lautrbach <plautrba@redhat.com> 0.6.5-10
- fix C compiler flags

* Mon Feb 14 2011 Petr Lautrbach <plautrba@redhat.com> 0.6.5-9
- set PIE and RELRO flags (#676002)

* Mon Dec 13 2010 Petr Lautrbach <plautrba@redhat.com> 0.6.5-8
- send close fd command to shell first (#618995)
- avoid assertion for telinit u on ppc64 (#648431)

* Tue Sep 21 2010 Petr Lautrbach <plautrba@redhat.com> 0.6.5-7
